...
function updateCarousel2() {
  ...
  function moveSlide3(step) {
      ...
      const slideWidth = items[0].offsetWidth;
      carouselInner.style.transform = `translateX(${-currentSlide3 * slideWidth}px)`;
...
let showMessageInterval;
  ...
  function toggleFloatingMessage() {
    ...
    // setTimeout(() => clearInterval(showMessageInterval), 60000); // Detener después de 1 minuto
